            ...
            match self.reader.read_event_into(&mut buf) {
                    ...
                    match tag_name.as_str() {
                        ...
                        "navpoint" if in_nav_map => {
                            if nav_point_depth > 0 {
                                // Descending into a child: save current state
                        ...
                        "navlabel" if nav_point_depth > 0 => {
                            in_nav_label = true;
                        }
                        "content" if nav_point_depth > 0 => {
                ...
                Ok(Event::End(ref e)) => {
                    ...
                    match tag_name.as_str() {
                        ...
                        "navpoint" if nav_point_depth > 0 => {
                            nav_point_depth -= 1;

                            // Emit entry if it references a chapter file
                            if !cur_src.is_empty() {
