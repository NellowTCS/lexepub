...
mod edge_case_tests {
    ...
    #[test]
    fn test_epub_with_special_characters() {
        futures::executor::block_on(async {
    ...
    #[test]
    fn test_epub_with_empty_chapters() {
        futures::executor::block_on(async {
    ...
    #[test]
    fn test_epub_with_missing_manifest_items() {
        futures::executor::block_on(async {
    ...
    #[test]
    fn test_epub_with_duplicate_ids() {
        futures::executor::block_on(async {
    ...
    #[test]
    fn test_epub_with_circular_references() {
        futures::executor::block_on(async {
    ...
    #[test]
    fn test_epub_with_very_long_filenames() {
        futures::executor::block_on(async {
    ...
    #[test]
    fn test_epub_with_binary_content_in_chapters() {
        futures::executor::block_on(async {
    ...
    #[test]
    fn test_epub_with_multiple_rootfiles() {
        futures::executor::block_on(async {
    ...
    #[test]
    fn test_epub_with_empty_metadata() {
        futures::executor::block_on(async {
    ...
    #[test]
    fn test_epub_with_compressed_content() {
        futures::executor::block_on(async {
    ...
    #[test]
    fn test_epub_with_large_manifest() {
        futures::executor::block_on(async {
