...
export interface InitOutput {
  ...
  readonly wasmepubextractor_get_chapter_resource: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly wasmepubextractor_get_resource: (
    a: number,
    b: number,
    c: number,
  ) => any;
  ...
  readonly wasmepubextractor_resolve_chapter_resource_path: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => any;
  readonly wasm_bindgen__convert__closures_____invoke__h64d2f1ae602a501f: (
    a: number,
    b: number,
    c: any,
  ) => [number, number];
  readonly wasm_bindgen__convert__closures_____invoke__h022fdcc8ac41b2bf: (
    a: number,
    b: number,
    c: any,
    d: any,
